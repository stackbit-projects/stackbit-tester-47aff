...
1. Get "stackbit-deploy (Read+Write)" API token from your [Sanity management console](https://manage.sanity.io/projects/k0j7otlr/settings/api)
...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/sanity-pull --ssg gatsby --sanity-project-id k0j7otlr --sanity-token $SANITY_ACCESS_TOKEN
...
To start editing your site, you can use the Sanity interface at https://stackbit-tester-47aff.sanity.studio/.
...
Generated at `2021-10-23T21:14:49.275Z` by Stackbit version `0.3.55`.